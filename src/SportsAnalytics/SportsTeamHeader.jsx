  ...
  return (
    <div className="team-header sports-team-header">
      <div className="header-content">
		...
		<p className="sport-team-content">This hands-on sports analytics program is designed to provide a real-world experience in analyzing and predicting sports outcomes.</p>
        <div className="outcome-section">
		  ...
		  <p className="sport-team-content">The sports analytics program prepares you to apply professional techniques used by analysts in real-world sports environments.</p>
		</div>
      </div>
